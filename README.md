...
<!-- MAIN HEADING -->
  <h3><b>Waza To do App </b></h3>

https://github.com/ishimwepati/to-do-react.git
...
> This is a To do App project built React JS.
...
```sh
  cd my-folder
  git clone https://github.com/ishimwepati/to-do-react.git
```
<!-- INSTALL -->
